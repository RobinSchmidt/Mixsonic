                                       ...
                                       TimeSliceThread &threadToUse)                                        
{
  ...
  fileListComponent->setColour(FileListComponent::backgroundColourId, skin->backgroundColor);
  fileListComponent->setColour(FileListComponent::outlineColourId,    skin->outlineColor);
