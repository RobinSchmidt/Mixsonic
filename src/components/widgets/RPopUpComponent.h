#ifndef RPopUpComponent_h
#define RPopUpComponent_h
...
for a popup menu. The component is to  be used by passing a content-component (via 
setContentComponent) which will contain the actual stuff. After the sontent component has been 
passed, the popup can be made to appear modally or non-modally via the respective show... 
methods.

*/

class RPopUpComponent : public RWidget  //, public ComponentMovementWatcher
                                        // why do we actually need the RWidget baseclass? can't we 
...
public:
  ...
  RPopUpComponent(const Skin *skinToUse);
...
protected:
  ...
  JUCE_LEAK_DETECTOR(RPopUpComponent);
};
...
public:
  ...
  JUCE_LEAK_DETECTOR(RPopUpOwner);
};
...
class ROwnedPopUpComponent : public RPopUpComponent, public ComponentMovementWatcher
{
...
public:
  ...
  /** Creates an empty popup component. */
  ROwnedPopUpComponent(Component *ownerComponent, const Skin *skinToUse);
...
protected:
  ...
  JUCE_LEAK_DETECTOR(ROwnedPopUpComponent);
};
