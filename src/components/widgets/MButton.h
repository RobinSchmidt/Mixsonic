...
This class is a juce::ToggleButton extended by the functionality of MWidget. 

\todo get rid of this class, use MButton2

*/

class MButton : public ToggleButton, public MWidget
{
...
public:
  ...
  MButton(Skin *skinToUse, int newSymbolIndex);    

  /** Constructs a button with text. */
  MButton(Skin *skinToUse, const String& componentName = String("MButton"));
