...
public:
  ...
  //-----------------------------------------------------------------------------------------------
  // we mimic some of the CoordinateSystem's (or its subclasses) functions and pass the respective 
  // arguments  through to both of our encapsulated CoordinateSystems:
